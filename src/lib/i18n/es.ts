...
export const es = {
  ...
  swap: {
    ...
    networkFeeWarning: "Necesitas un poco de ETH en Base para la comisión de red.",
    impactHigh: "Tu intercambio moverá el precio. ¿Quieres continuar?",
  ...
  confirm: {
    ...
    subtitle: "Verifica los datos antes de firmar.",
    youSend: "Envías",
    youReceive: "Recibes",
    rate: "Precio",
    fee: "Comisión Remes",
    ...
    nonCustodial: "Solo tú puedes cancelar — tu billetera, tus fondos.",
